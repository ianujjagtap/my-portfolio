        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-4">
            <Link
              ...
              target={project.details ? undefined : '_blank'}
            >
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2">
              {project.technologies.map((technology, index) => (
                <Tooltip key={index}>
                  <TooltipTrigger>
                    <div className="flex size-6 min-h-6 min-w-6 max-h-6 max-w-6 items-center justify-center overflow-hidden transition-all duration-300 hover:scale-120 hover:cursor-pointer">
                      {technology.icon}
                    </div>
                  </TooltipTrigger>
                  <TooltipContent>
